...
class TestConfirmationReleaseAsV5User:
    # log variable instantiation
    logger = LogGen.loggen()

    def test_022_confirmation_release_as_v5_user(self, setup):
        self.logger.info("********test_022_confirmation_release_as_v5_user_override_v4 : started********")
        ...
        # confirm part modules as v5 user
        rp.confirm_part_modules_as_v5_user_override_v4()
        # click OK
        rp.click_ok()
        ...
        self.logger.info("******test_022_confirmation_release_as_v5_user_override_v4  : passed*******")
        self.logger.info("******test_022_confirmation_release_as_v5_user_override_v4  : completed ********")
