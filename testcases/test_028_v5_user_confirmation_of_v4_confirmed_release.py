...
class TestV5UserConfirmationOfV4ConfirmedRelease:
    # log variable instantiation
    logger = LogGen.loggen()

    def test_028_v5_user_confirmation_of_v4_confirmed_release(self, setup):
        self.logger.info("**********test_028_v5_user_confirmation_of_v4_confirmed_release : started**********")
        ...
        rp.confirm_part_modules_as_v5_user()
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[7]/p[2]")):
            ...
            self.logger.info("******confirm release as v5 user successful : " + text + "*******")
            assert True, "confirm release as v5 user successful : " + text
        else:
            self.logger.info("******confirm release as v5 user unsuccessful*******")
            assert False, "confirm release as v5 user unsuccessful."

        self.logger.info("*********test_028_v5_user_confirmation_of_v4_confirmed_release : passed*******")
        self.logger.info("*********test_028_v5_user_confirmation_of_v4_confirmed_release : completed ********")
