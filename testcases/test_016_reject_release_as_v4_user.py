...
class TestRejectReleaseAsV4User:
    # log variable instantiation
    logger = LogGen.loggen()

    def test_015_reject_release_as_v4_user(self, setup):
        self.logger.info("********test_016_reject_as_v4_user : started********")
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[6]/p[2]")):
            ...
            self.logger.info("******016_reject release as v4 user unsuccessful*******")
            assert False, "016_reject release as v4 user unsuccessful."

        self.logger.info("********test_016_reject_as_v4_user  : passed*******")
        self.logger.info("*********test_016_reject_as_v4_user  : completed ********")
