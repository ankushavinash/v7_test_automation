...
class Test_040:
    ...
    def test_040_discard_v7_confirmed_release_as_v7_user(self, setup):
        self.logger.info("********test_040_discard_v7_confirmed_release_as_v7_user : started********")
        ...
        self.logger.info("********test_040_discard_v7_confirmed_release_as_v7_user : passed*******")
        self.logger.info("*********test_040_discard_v7_confirmed_release_as_v7_user : completed ********")
