...
class TestDiscardV4ConfirmedReleaseAsV4User:
    ...
    def test_017_discard_v4_confirmed_release_as_v4_user(self, setup):
        self.logger.info("********test_017_discard_v4_confirmed_release_as_v4_user : started********")
        ...
        self.logger.info("********test_017_discard_v4_confirmed_release_as_v4_user : passed*******")
        self.logger.info("*********test_017_discard_v4_confirmed_release_as_v4_user : completed ********")
