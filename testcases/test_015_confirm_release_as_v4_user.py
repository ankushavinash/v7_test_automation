...
class TestConfirmationReleaseAsV4User:
    ...
    def test_015_confirmation_release_as_v4_user(self, setup):
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[6]/p[2]")):
            ...
            self.logger.info("******015_confirm release as v4 user unsuccessful*******")
            assert False, "015_confirm release as v4 user unsuccessful."
