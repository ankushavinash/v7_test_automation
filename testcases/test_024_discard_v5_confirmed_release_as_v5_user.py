...
class TestDiscardV5ConfirmedReleaseAsV5User:
    # log variable instantiation
    logger = LogGen.loggen()

    def test_024_discard_v5_confirmed_release_as_v5_user(self, setup):
        self.logger.info("********test_024_discard_v5_confirmed_release_as_v5_user : started********")
        ...
        self.logger.info("*********confirm release as v4 user successful : " + v5_confirm_release + "****************")
        ...
        self.logger.info("********test_024_discard_v5_confirmed_release_as_v5_user : passed*******")
        self.logger.info("*********test_024_discard_v5_confirmed_release_as_v5_user : completed ********")
