...
class Test_037:
    ...
    def test_037_v6_user_rejection_of_v5_confirmed_release(self, setup):
        self.logger.info("**********test_037_v6_user_rejection_of_v5_confirmed_release : started**********")
        ...
        # Click on user confirmation project v6 user
        ...
        rp.reject_part_modules_as_v6_user()
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[8]/p[2]")):
            ...
            self.logger.info("******reject release as v5 user successful : " + v6_user_validation + "*******")
            assert True, "reject release as v5 user successful : " + v6_user_validation
        else:
            self.logger.info("******reject release as v6 user unsuccessful*******")
            assert False, "reject release as v6 user unsuccessful."

        self.logger.info("*********test_037_v6_user_rejection_of_v5_confirmed_release : passed*******")
        self.logger.info("*********test_037_v6_user_rejection_of_v5_confirmed_release : completed ********")
