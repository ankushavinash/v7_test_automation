...
class TestRejectReleaseAsV4User:
    ...
    def test_017_reject_release_as_v4_user(self, setup):
        self.logger.info("********test_017_reject_as_v4_user : started********")
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[6]/p[2]")):
            ...
            assert False, "017_reject release as v4 user unsuccessful."

        self.logger.info("********test_017_reject_as_v4_user  : passed*******")
        self.logger.info("*********test_017_reject_as_v4_user  : completed ********")
