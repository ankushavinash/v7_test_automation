...
class Test_036:
    ...
    def test_036_v6_user_confirmation_of_v5_confirmed_release(self, setup):
        self.logger.info("**********test_036_v6_user_confirmation_of_v5_confirmed_release : started**********")
        ...
        # V5 user confirmation of release
        v5_confirmed_release = rp.user_confirmation_as_v5_user_override_v4()
        driver.switch_to.window(main_window)
        self.logger.info("*****confirm release as v5 user successful : " + v5_confirmed_release + "******")
        ...
        self.logger.info("********Login again as V6 user and search release: " + release_id + "********")
        ...
        self.logger.info("*************Click on user confirmation of project as v6 user **************")
        # click on confirm or reject button
        rp.click_confirmation_or_reject_button()
        # Click on confirm button for confirmation of part modules
        rp.confirm_part_modules_as_v6_user()
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[8]/p[2]")):
            ...
            v6_user_validation = text.replace("[v7_automation_v6_user]", "").strip()
            self.logger.info("******confirm release as v6 user successful : " + v6_user_validation + "*******")
            assert True, "confirm release as v6 user successful : " + v6_user_validation
        else:
            self.logger.info("******confirm release as v6 user unsuccessful*******")
            assert False, "confirm release as v6 user unsuccessful."

        self.logger.info("*********test_036_v6_user_confirmation_of_v5_confirmed_release : passed*******")
        self.logger.info("*********test_036_v6_user_confirmation_of_v5_confirmed_release : completed ********")
