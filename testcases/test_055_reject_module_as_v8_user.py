...
class Test_055:
    ...
    def test_055_reject_module_as_v8_user(self, setup):
        self.logger.info("********test_055_reject_module_as_v8_user : started********")
        ...
        # V8 confirmation
        rp.final_v8_rejection(release_letter_comment, internal_comment)
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='schdata']//td[12]//tbody/tr[2]//b")):
            ...
            self.logger.info("******reject module as v8 user successful. status : " + text + "*******")
            assert True, "reject module as v8 user successful. status : " + text
        else:
            self.logger.info("******reject module as v8 user unsuccessful*******")
            assert False, "reject module as v8 user unsuccessful."

        self.logger.info("********test_055_reject_module_as_v8_user  : passed*******")
        self.logger.info("*********test_055_reject_module_as_v8_user  : completed ********")
