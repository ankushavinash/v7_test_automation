...
class Test_048:
    ...
    def test_048_module_confirmation_as_v5_user(self, setup):
        self.logger.info("********test_048_module_confirmation_as_v5_user : started********")
        ...
        if bu.is_displayed((By.ID, "F11197")):
            ...
            self.logger.info("******confirm module as v5 user successful. status : " + text + "*******")
            assert True, "confirm module as v5 user successful. status : " + text
        else:
            self.logger.info("******confirm module as v5 user unsuccessful*******")
            assert False, "confirm module as v5 user unsuccessful."

        self.logger.info("********test_048_module_confirmation_as_v5_user  : passed*******")
        self.logger.info("*********test_048_module_confirmation_as_v5_user  : completed ********")
