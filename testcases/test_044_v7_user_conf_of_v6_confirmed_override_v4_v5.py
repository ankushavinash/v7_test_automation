...
class Test_044:
    ...
    def test_044_v7_user_conf_of_v6_confirmed_override_v4_v5(self, setup):
        self.logger.info("**********test_044_v7_user_conf_of_v6_confirmed_override_v4_v5 : started**********")
        ...
        v6_confirmed_release = rp.user_confirmation_as_v6_user_override_v4_and_v5()
        driver.switch_to.window(main_window)
        self.logger.info("*****confirm release as v6 user successful : " + v6_confirmed_release + "******")
        ...
        self.logger.info("********Login again as V7 user and search release: " + release_id + "********")
        ...
        rp.confirm_part_modules_as_v7_user()
        ...
        self.logger.info("*********test_044_v7_user_conf_of_v6_confirmed_override_v4_v5 : passed*******")
        self.logger.info("*********test_044_v7_user_conf_of_v6_confirmed_override_v4_v5 : completed ********")
