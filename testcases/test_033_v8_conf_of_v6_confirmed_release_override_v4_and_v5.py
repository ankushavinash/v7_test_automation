...
class Test_033:
    ...
    def test_033_v8_confirmation_of_v5_confirmed_release_override_v4_and_v5(self, setup):
        self.logger.info("****test_033_v8_confirmation_of_v5_confirmed_release_override_v4_v5 : started****")
        ...
        self.logger.info("******test_033_v8_confirmation_of_v5_confirmed_release_override_v4_v5 : passed******")
        self.logger.info("***test_033_v8_confirmation_of_v5_confirmed_release_override_v4_v5 : completed *****")
