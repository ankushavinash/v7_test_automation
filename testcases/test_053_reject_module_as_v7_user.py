...
class Test_053:
    ...
    def test_053_reject_module_as_v7_user(self, setup):
        self.logger.info("********test_053_reject_module_as_v7_user : started********")
        ...
        # click on module confirmation as v7 user
        rp.click_module_confirmation()
        # click on reject button as V7 user and enter comment to reject module
        rp.click_reject_as_v7_user(reject_comment_v7_user, main_window)
        ...
        if bu.is_displayed((By.ID, "F11197")):
            ...
            self.logger.info("******reject module as v7 user successful. status : " + text + "*******")
            assert True, "reject module as v7 user successful. status : " + text
        else:
            self.logger.info("******reject module as v7 user unsuccessful*******")
            assert False, "reject module as v7 user unsuccessful."

        self.logger.info("********test_053_reject_module_as_v7_user  : passed*******")
        self.logger.info("*********test_053_reject_module_as_v7_user  : completed ********")
