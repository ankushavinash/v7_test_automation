...
class Test_030:
    ...
    def test_030_confirmation_release_as_v6_user_override_v4_and_v5(self, setup):
        self.logger.info("********test_030_confirmation_release_as_v6_user_override_v4_and_v5 : started********")
        ...
        # confirm part modules as v6 user override v4 and v5 user
        rp.confirm_part_modules_as_v6_user_override_v4_and_v5()
        self.logger.info("*********Confirm part modules as V6 user override V4 and V5 user*********")
        # click OK
        rp.click_ok()
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[8]/p[2]")):
            ...
            assert True, "confirm release as v6 user successful : " + text
        else:
            self.logger.info("******confirm release as v6 user unsuccessful*******")
            assert False, "confirm release as v6 user unsuccessful."

        self.logger.info("******test_030_confirmation_release_as_v6_user_override_v4_and_v5  : passed*******")
        self.logger.info("******test_030_confirmation_release_as_v6_user_override_v4_and_v5  : completed ********")
