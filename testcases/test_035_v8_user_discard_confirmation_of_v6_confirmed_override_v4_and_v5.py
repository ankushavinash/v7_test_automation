...
class TestV8UserDiscardConfirmationOfV5ConfirmedReleaseOverrideV4AndV5:
    # log variable instantiation
    logger = LogGen.loggen()

    def test_035_v8_user_discard_confirmation_of_v6_confirmed_override_v4_and_v5(self, setup):
        ...
        self.logger.info("********V6 confirmed release displayed. Release id : " + v6_confirmed_release_id + " *******")
