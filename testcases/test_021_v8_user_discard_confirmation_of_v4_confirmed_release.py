...
class TestV8UserDiscardConfirmationOfV4ConfirmedRelease:
    # log variable instantiation
    logger = LogGen.loggen()

    def test_021_v8_user_discard_of_v4_confirmed_release(self, setup):
        self.logger.info("*******test_021_v8_user_discard_confirmation_of_v4_confirmed_release : started*******")
        ...
        self.logger.info("*****test_021_v8_user_discard_confirmation_of_v4_confirmed_release : passed******")
        self.logger.info("*****test_021_v8_user_discard_confirmation_of_v4_confirmed_release : completed*****")
