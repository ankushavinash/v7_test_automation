...
class Test_032:
    ...
    def test_032_discard_v6_confirmed_release_as_v6_user(self, setup):
        self.logger.info("********test_032_discard_v6_confirmed_release_as_v6_user : started********")
        ...
        self.logger.info("*********confirm release as v4 user successful : " + v6_confirm_release + "****************")
        ...
        self.logger.info("********test_032_discard_v6_confirmed_release_as_v6_user : passed*******")
        self.logger.info("*********test_032_discard_v6_confirmed_release_as_v6_user : completed ********")
