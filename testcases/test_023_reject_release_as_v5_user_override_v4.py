...
class TestRejectReleaseAsV5User:
    # log variable instantiation
    logger = LogGen.loggen()

    def test_023_reject_release_as_v5_user(self, setup):
        self.logger.info("********test_023_reject_release_as_v5_user_override_v4 : started********")
        ...
        rp.reject_part_modules_as_v5_user_override_v4()
        # click OK
        rp.click_ok()
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[7]/p[2]")):
            ...
            self.logger.info("******reject release as v5 user successful : " + text + "*******")
            assert True, "reject release as v5 user successful : " + text
        else:
            self.logger.info("******reject release as v5 user unsuccessful*******")
            assert False, "reject release as v5 user unsuccessful."

        self.logger.info("******test_023_reject_release_as_v5_user_override_v4  : passed*******")
        self.logger.info("******test_023_reject_release_as_v5_user_override_v4  : completed ********")
