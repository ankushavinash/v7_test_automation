...
class Test_037:
    ...
    def test_037_reject_release_as_v7_user_override_other_user(self, setup):
        self.logger.info("********test_037_reject_release_as_v7_user_override_other_user : started********")
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='ucmatrix']/tbody/tr[2]/td[9]/p[2]")):
            ...
            self.logger.info("******reject release as v7 user successful : " + text + "*******")
            assert True, "reject release as v7 user successful : " + text
        else:
            self.logger.info("******reject release as v7 user unsuccessful*******")
            assert False, "reject release as v7 user unsuccessful."

        self.logger.info("******test_037_reject_release_as_v7_user_override_other_user  : passed*******")
        self.logger.info("******test_037_reject_release_as_v7_user_override_other_user  : completed ********")
