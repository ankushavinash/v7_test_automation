...
class Test_054:
    ...
    def test_054_module_confirmation_as_v8_user(self, setup):
        self.logger.info("********test_054_module_confirmation_as_v8_user : started********")
        ...
        # V8 confirmation
        rp.final_v8_confirmation(internal_comment)
        ...
        if bu.is_displayed((By.XPATH, "//*[@id='schdata']//td[12]//tbody/tr[2]//b")):
            ...
            self.logger.info("******module confirmed as v8 user successful. status : " + text + "*******")
            assert True, "module confirmed as v8 user successful. status : " + text
        else:
            self.logger.info("******module confirmation as v8 user unsuccessful*******")
            assert False, "module confirmation as v8 user unsuccessful."

        self.logger.info("********test_054_module_confirmation_as_v8_user  : passed*******")
        self.logger.info("*********test_054_module_confirmation_as_v8_user  : completed ********")
